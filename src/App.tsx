    ...
    <div className="min-h-screen bg-brand-bg">
      ...
      <main className="lg:ml-[180px]">
        ...
        <section id="welcome" className="min-h-screen pt-16 lg:pt-0">
          {/* Hero */}
          <div className="relative min-h-screen lg:min-h-[90vh] flex flex-col lg:flex-row overflow-hidden">
            {/* Background Image - Desktop: contain to see full image */}
            <div className="absolute inset-0 lg:flex lg:items-center lg:justify-center lg:bg-black">
              <img 
                src={welcomeContent.hero.image} 
                alt="Welcome"
                className="w-full h-full lg:w-auto lg:h-[90vh] object-cover lg:object-contain animate-scale-in"
              />
              <div className="absolute inset-0 bg-gradient-to-r from-black/70 via-black/40 to-transparent lg:bg-gradient-to-r lg:from-black/60 lg:via-transparent lg:to-black/60" />
            </div>
            
            {/* Desktop: Text card on right */}
            <div className="hidden lg:flex relative z-10 w-full max-w-7xl mx-auto px-6 items-center justify-end">
              <div className="card-overlay max-w-md animate-fade-in-up" style={{ animationDelay: '200ms' }}>
                <h2 className="text-2xl font-bold text-white mb-2">{welcomeContent.hero.title}</h2>
                <h3 className="text-sm uppercase tracking-wide text-brand-text-secondary mb-4">
                  {welcomeContent.hero.subtitle}
                </h3>
                {welcomeContent.hero.paragraphs.map((para, i) => (
                  <p key={i} className="text-brand-text-secondary text-sm leading-relaxed mb-3">
                    {para}
                  </p>
                ))}
                <a 
            ...
            {/* Mobile: Text card lower on screen */}
            <div className="lg:hidden relative z-10 w-full" style={{ marginTop: '60vh' }}>
              <div className="card-overlay mx-4 mb-8 animate-fade-in-up" style={{ animationDelay: '200ms' }}>
                <h2 className="text-xl font-bold text-white mb-1">{welcomeContent.hero.title}</h2>
                <h3 className="text-xs uppercase tracking-wide text-brand-text-secondary mb-3">
                  {welcomeContent.hero.subtitle}
                </h3>
                {welcomeContent.hero.paragraphs.map((para, i) => (
                  <p key={i} className="text-brand-text-secondary text-xs leading-relaxed mb-2">
                    {para}
                  </p>
                ))}
                <a 
          ...
          <div className="py-16 px-6 max-w-2xl mx-auto">
            <form ref={contactFormRef} onSubmit={handleContactSubmit} className="space-y-6">
              ...
              <div>
                ...
                <input type="text" name="location" className="input-field" required />
              </div>
                ...
                <div className="space-y-2">
                  {contactContent.form.fields.packages.options.map((option, i) => (
                    <label key={i} className="flex items-center gap-3 cursor-pointer">
                      <input type="checkbox" name="packages" value={option} className="w-4 h-4 border border-gray-500 accent-brand-accent" />
              ...
              <div>
                ...
                <div className="space-y-2">
                  {contactContent.form.fields.addons.options.map((option, i) => (
                    <label key={i} className="flex items-center gap-3 cursor-pointer">
                      <input type="checkbox" name="addons" value={option.value} className="w-4 h-4 border border-gray-500 accent-brand-accent" />
              ...
              <div>
                ...
                <select name="referral" className="input-field" required>
              ...
              <div>
                ...
                <textarea name="message" className="input-field min-h-[120px] resize-none" required />
              </div>
